        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceAccountEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocalRealmName = table.Column<string>(type: "TEXT", nullable: false),
                    JwksKeyId = table.Column<string>(type: "TEXT", nullable: true),
                    JwksGeneratedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    KeycloakUrl = table.Column<string>(type: "TEXT", nullable: true),
                    KeycloakRealm = table.Column<string>(type: "TEXT", nullable: true),
                    LastKeycloakSync = table.Column<DateTime>(type: "TEXT", nullable: true),
                    KeycloakSyncEnabled = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedLocally = table.Column<bool>(type: "INTEGER", nullable: false),
                    KeycloakUserId = table.Column<string>(type: "TEXT", nullable: true),
                    LastSyncToKeycloak = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastSyncFromKeycloak = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
